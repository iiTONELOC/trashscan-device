...
export type SettingsProps = {
  ...
  missingSettings: {
    found: boolean;
    missing: string[];
    handleSettingAdded: (setting: string) => void;
  };
};
  ...
  return (
    <div className="Setting-modal-info-container">
      <p className="Setting-modal-info">
        The following settings are required for the application to function but are unique to you
        and your system. Please fill out all variables currently marked in{' '}
        <span className="Red-span">RED</span>.
      </p>
      <p className="Setting-modal-info">
        You will not be able to use the application or close the modal until all settings have been
        provided.
      </p>
    </div>
  );
...
export default function Settings(props: Readonly<SettingsProps>): React.JSX.Element {
